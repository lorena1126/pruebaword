	...
	if ( have_comments() ) : ?>
		<div id="comments" class="comments-area">
			...
			<ul class="commentlist">
				...
				wp_list_comments( array( 'callback' => 'central_comment', 'style' => 'ul' ) ); ?>
			</ul><!-- .commentlist -->
			<?php /* show comments navigation */
			if ( 1 < get_comment_pages_count() && get_option( 'page_comments' ) ) : ?>
				<nav id="comment-nav-below" class="navigation" role="navigation">
					<div class="nav-previous"><?php previous_comments_link( '&larr; ' . __( 'Older Comments', 'central' ) ); ?></div>
					<div class="nav-next"><?php next_comments_link( __( 'Newer Comments', 'central' ) . ' &rarr;' ); ?></div>
					<div class="clear"></div>
				</nav>
			<?php endif;
			/* show comment form */
